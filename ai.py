...
class AI():
    ...
    def listen_for_name(self):
        ...
        print("Waiting for name:", self.__name)

        phrase = ""
        normalize_name = str.lower(normalize(self.__name))

        print("Normalized name:", normalize_name)
        
        allowed_phrases = [normalize_name, "la dos", "globos", "clavos", "lados"]

        while phrase not in allowed_phrases:
        ...
        self.after_listening.trigger(self.__name)
        
        return phrase

    def play(self, route: str):
